export const tools = [
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Liefert Fahrradstationen mit mindestens der angegebenen Anzahl verfügbarer Stellplätze.',
      parameters: {
        type: 'object',
        properties: {
          minNumOfDocks: {
  ...
  },
  {
    ...
    function: {
      ...
      description:
        'Liefert den aktuellen Fahrradbestand und die verfügbaren Stellplätze aller Fahrradstationen, deren Name den angegebenen Namen oder Teil des Namens enthält.',
      parameters: {
        type: 'object',
        properties: {
          stationName: {
